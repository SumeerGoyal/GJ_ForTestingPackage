...
public class ParkingLotTest {
	...
	public static void handle_read_string(String str) {
		...
		if (str.startsWith("create_parking_lot")) {
			...
			if (str.startsWith("park")) {
			...
			else if (str.startsWith("registration_numbers_for_cars_with_color")) {
			...
			else if (str.startsWith("slot_number_for_cars_with_colour")) {
				...
				String retStr = PS.handle_slot_number_for_registration_number(carReg);
			}
	}
}